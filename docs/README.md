...
| [A06 bounded MCAP import evidence](implementation/WP-A06-Bounded-MCAP-Import.md) | Maintained parsing, explicit unsupported outcomes, independent fixtures and measured memory |
| [A05 resource-limit evidence](implementation/WP-A05-Worker-Resource-Limits.md) | Linux per-process CPU/AS policy, trusted launcher, migration and remaining acceptance |
